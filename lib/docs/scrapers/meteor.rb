module Docs
  class Meteor < UrlScraper
    ...
    version "1.4" do
      self.release = "1.4.4"
      self.base_urls = ["https://guide.meteor.com/", "https://docs.meteor.com/v#{release}/", "http://blazejs.org/"]
    end

    version "1.3" do
      self.release = "1.3.5"
      self.base_urls = ["https://guide.meteor.com/v1.3/", "https://docs.meteor.com/v#{release}/"]
