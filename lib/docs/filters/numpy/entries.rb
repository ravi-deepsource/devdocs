    ...
    class EntriesFilter < Docs::EntriesFilter
      ...
      def get_type
        ...
        if nav_items[3]
          ...
          if type.start_with?("numpy.polynomial.", "numpy.poly1d.")
            type = "Polynomials"
          elsif type.start_with?("numpy.ufunc.")
            type = "Universal functions"
          elsif type.start_with?("numpy.nditer.", "numpy.lib.Arrayterator.", "numpy.flatiter.")
            type = "Indexing routines"
          elsif type.start_with?("numpy.record.", "numpy.recarray.", "numpy.broadcast.", "numpy.matrix.")
            ...
            type = "Scalars"
          elsif type.start_with?("numpy.char.chararray.", "numpy.core.defchararray.chararray.")
